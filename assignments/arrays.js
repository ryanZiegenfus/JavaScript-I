...
function carInfo(num) {
    return "Car " + inventory[num - 1].id  + " is a " + inventory[num - 1].car_year + " " + inventory[num - 1].car_make + " " + inventory[num - 1].car_model;
}
